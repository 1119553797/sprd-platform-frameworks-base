...
class AppCrashDialog extends BaseErrorDialog {
    ...
    public AppCrashDialog(Context context, AppErrorResult result, ProcessRecord app) {
        super(context);
        ...
        if ((app.pkgList.size() == 1) &&
            ...
            setMessage(res.getString(
                    com.android.internal.R.string.crash_application,
                    name.toString(), app.info.processName));
        } else {
            name = app.processName;
            setMessage(res.getString(
                    com.android.internal.R.string.crash_process,
                    name.toString()));
        }
        ...
        setButton(DialogInterface.BUTTON_POSITIVE,
                res.getText(com.android.internal.R.string.crash_close),
...
*/
        setTitle(res.getText(com.android.internal.R.string.crash_title));
    ...
    private final Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            synchronized (mProc) {
                if (mProc != null && mProc.crashDialog == AppCrashDialog.this) {
