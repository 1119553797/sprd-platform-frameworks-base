...
*/
    ...
    int RIL_REQUEST_VIDEOPHONE_DIAL = 104;
    int RIL_REQUEST_VIDEOPHONE_CODEC = 105;
    int RIL_REQUEST_VIDEOPHONE_HANGUP = 106;
    int RIL_REQUEST_VIDEOPHONE_ANSWER = 107;
    int RIL_REQUEST_VIDEOPHONE_FALLBACK = 108;
    int RIL_REQUEST_VIDEOPHONE_STRING = 109;
    int RIL_REQUEST_VIDEOPHONE_LOCAL_MEDIA = 110;
    int RIL_REQUEST_VIDEOPHONE_RECORD_VIDEO = 111;
    int RIL_REQUEST_VIDEOPHONE_RECORD_AUDIO = 112;
    int RIL_REQUEST_VIDEOPHONE_TEST = 113;
    int RIL_REQUEST_GET_CURRENT_VIDEOCALLS = 114;
    int RIL_REQUEST_VIDEOPHONE_CONTROL_AUDIO = 115;
    int RIL_REQUEST_VIDEOPHONE_CONTROL_IFRAME = 116;

    int RIL_REQUEST_MBBMS_GSM_AUTHEN = 117;
    int RIL_REQUEST_MBBMS_USIM_AUTHEN = 118;
    int RIL_REQUEST_MBBMS_SIM_TYPE = 119;

    int RIL_REQUEST_GPRS_ATTACH = 120;
    int RIL_REQUEST_GPRS_DETACH = 121;
    
    int RIL_REQUEST_GET_REMAIN_TIMES = 122;
    int RIL_REQUEST_GET_SIM_CAPACITY = 123;
	int RIL_REQUEST_QUERY_COLP = 124;
	int RIL_REQUEST_QUERY_COLR = 125;
	
	int RIL_REQUEST_MMI_ENTER_SIM = 126;
    int RIL_REQUEST_SET_CMMS = 127;
    int RIL_REQUEST_SIM_POWER = 128;

    int RIL_REQUEST_HANGUP_ALL_CALLS = 129;
	...
	// following is for videophone h324
	int RIL_UNSOL_VIDEOPHONE_DATA = 1031;
	int RIL_UNSOL_VIDEOPHONE_CODEC = 1032;
	int RIL_UNSOL_VIDEOPHONE_DCPI = 1033;
	int RIL_UNSOL_VIDEOPHONE_DSCI = 1034;
	int RIL_UNSOL_VIDEOPHONE_STRING = 1035;
	int RIL_UNSOL_VIDEOPHONE_REMOTE_MEDIA = 1036;
	int RIL_UNSOL_VIDEOPHONE_RELEASING = 1037;
	int RIL_UNSOL_VIDEOPHONE_RECORD_VIDEO = 1038;
    int RIL_UNSOL_VIDEOPHONE_MEDIA_START = 1039;
