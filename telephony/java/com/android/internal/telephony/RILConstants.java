...
*/
    ...
    int RIL_REQUEST_MBBMS_GSM_AUTHEN = 116;
    int RIL_REQUEST_MBBMS_USIM_AUTHEN = 117;
    int RIL_REQUEST_MBBMS_SIM_TYPE = 118;

    int RIL_REQUEST_GPRS_ATTACH = 119;
    int RIL_REQUEST_GPRS_DETACH = 120;
    
    int RIL_REQUEST_GET_REMAIN_TIMES = 121;
    int RIL_REQUEST_GET_SIM_CAPACITY = 122;
	int RIL_REQUEST_QUERY_COLP = 123;
	int RIL_REQUEST_QUERY_COLR = 124;
	
	int RIL_REQUEST_MMI_ENTER_SIM = 125;
