...
public interface RILConstants {
    ...
    int ILLEGAL_SIM_OR_ME = 15;               /* network selection failure due
                                                 ...
                                                 retries needed */
    int SMS_SAVE_FAIL_FULL = 2000; //SPRD: add for ...
...
*/
    ...
    /* SPRD: add for sprd ril @{ */
    int RIL_SPRD_REQUEST_BASE = 5000;
    int RIL_REQUEST_VIDEOPHONE_DIAL = RIL_SPRD_REQUEST_BASE + 1;
    int RIL_REQUEST_VIDEOPHONE_CODEC = RIL_SPRD_REQUEST_BASE + 2;
    int RIL_REQUEST_VIDEOPHONE_HANGUP = RIL_SPRD_REQUEST_BASE + 3;
    int RIL_REQUEST_VIDEOPHONE_ANSWER = RIL_SPRD_REQUEST_BASE + 4;
    int RIL_REQUEST_VIDEOPHONE_FALLBACK = RIL_SPRD_REQUEST_BASE + 5;
    int RIL_REQUEST_VIDEOPHONE_STRING = RIL_SPRD_REQUEST_BASE + 6;
    int RIL_REQUEST_VIDEOPHONE_LOCAL_MEDIA = RIL_SPRD_REQUEST_BASE + 7;
    int RIL_REQUEST_VIDEOPHONE_RECORD_VIDEO = RIL_SPRD_REQUEST_BASE + 8;
    int RIL_REQUEST_VIDEOPHONE_RECORD_AUDIO = RIL_SPRD_REQUEST_BASE + 9;
    int RIL_REQUEST_VIDEOPHONE_SET_VOICERECORDTYPE = RIL_SPRD_REQUEST_BASE + 10;
    int RIL_REQUEST_VIDEOPHONE_TEST = RIL_SPRD_REQUEST_BASE + 11;
    int RIL_REQUEST_GET_CURRENT_VIDEOCALLS = RIL_SPRD_REQUEST_BASE + 12;
    int RIL_REQUEST_VIDEOPHONE_CONTROL_AUDIO = RIL_SPRD_REQUEST_BASE + 13;
    int RIL_REQUEST_VIDEOPHONE_CONTROL_IFRAME = RIL_SPRD_REQUEST_BASE + 14;
    int RIL_REQUEST_MBBMS_GSM_AUTHEN = RIL_SPRD_REQUEST_BASE + 15;
    int RIL_REQUEST_MBBMS_USIM_AUTHEN = RIL_SPRD_REQUEST_BASE + 16;
    int RIL_REQUEST_MBBMS_SIM_TYPE = RIL_SPRD_REQUEST_BASE + 17;
    int RIL_REQUEST_GPRS_ATTACH = RIL_SPRD_REQUEST_BASE + 18;
    int RIL_REQUEST_GPRS_DETACH = RIL_SPRD_REQUEST_BASE + 19;
    int RIL_REQUEST_GET_SIM_CAPACITY = RIL_SPRD_REQUEST_BASE + 20;
    int RIL_REQUEST_QUERY_COLP = RIL_SPRD_REQUEST_BASE + 21;
    int RIL_REQUEST_QUERY_COLR = RIL_SPRD_REQUEST_BASE + 22;
    int RIL_REQUEST_MMI_ENTER_SIM = RIL_SPRD_REQUEST_BASE + 23;
    int RIL_REQUEST_END_ALL_CONNECTIONS = RIL_SPRD_REQUEST_BASE + 24;
    int RIL_REQUEST_GET_REMAIN_TIMES = RIL_SPRD_REQUEST_BASE + 25;
    int RIL_REQUEST_SET_CMMS = RIL_SPRD_REQUEST_BASE + 26;
    int RIL_REQUEST_SIM_POWER = RIL_SPRD_REQUEST_BASE + 27;
    int RIL_REQUEST_DIAL_EMERGENCY_CALL = RIL_SPRD_REQUEST_BASE + 28;
    int RIL_REQUEST_SEND_AT = RIL_SPRD_REQUEST_BASE + 29;//SPRD: add
    int RIL_REQUEST_SET_SPEED_MODE = RIL_SPRD_REQUEST_BASE + 30;

    int RIL_SPRD_UNSOL_RESPONSE_BASE = 6000;
    int RIL_UNSOL_VIDEOPHONE_DATA = RIL_SPRD_UNSOL_RESPONSE_BASE + 0;
    int RIL_UNSOL_VIDEOPHONE_CODEC = RIL_SPRD_UNSOL_RESPONSE_BASE + 1;
    int RIL_UNSOL_VIDEOPHONE_DCPI = RIL_SPRD_UNSOL_RESPONSE_BASE + 2;
    int RIL_UNSOL_VIDEOPHONE_DSCI = RIL_SPRD_UNSOL_RESPONSE_BASE + 3;
    int RIL_UNSOL_VIDEOPHONE_STRING = RIL_SPRD_UNSOL_RESPONSE_BASE + 4;
    int RIL_UNSOL_VIDEOPHONE_REMOTE_MEDIA = RIL_SPRD_UNSOL_RESPONSE_BASE + 5;
    int RIL_UNSOL_VIDEOPHONE_MM_RING = RIL_SPRD_UNSOL_RESPONSE_BASE + 6;
	int RIL_UNSOL_VIDEOPHONE_RELEASING = RIL_SPRD_UNSOL_RESPONSE_BASE + 7;
    int RIL_UNSOL_VIDEOPHONE_RECORD_VIDEO = RIL_SPRD_UNSOL_RESPONSE_BASE + 8;
    int RIL_UNSOL_VIDEOPHONE_MEDIA_START = RIL_SPRD_UNSOL_RESPONSE_BASE + 9;
    int RIL_UNSOL_RESPONSE_VIDEOCALL_STATE_CHANGED = RIL_SPRD_UNSOL_RESPONSE_BASE + 10;
    int RIL_UNSOL_ON_STIN = RIL_SPRD_UNSOL_RESPONSE_BASE + 11;
    int RIL_UNSOL_SIM_SMS_READY = RIL_SPRD_UNSOL_RESPONSE_BASE + 12;
    int RIL_UNSOL_SIM_DROP = RIL_SPRD_UNSOL_RESPONSE_BASE + 13;
    /* SPRD: @{*/
}
