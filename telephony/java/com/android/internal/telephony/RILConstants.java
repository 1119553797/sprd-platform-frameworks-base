...
*/
    ...
    int RIL_REQUEST_MBBMS_GSM_AUTHEN = 120;
    int RIL_REQUEST_MBBMS_USIM_AUTHEN = 121;
    int RIL_REQUEST_MBBMS_SIM_TYPE = 122;

    int RIL_REQUEST_GPRS_ATTACH = 123;
    int RIL_REQUEST_GPRS_DETACH = 124;
    
    int RIL_REQUEST_GET_REMAIN_TIMES = 125;
