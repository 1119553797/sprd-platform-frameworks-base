...
public interface SprdVideoPhone {
    ...
    /*
     * public void notifyPreciseVideoCallStateChanged(); public void
     * notifyNewRingingVideoCall(Connection cn); public void
     * notifyIncomingRingVideoCall(); public void
    ...
    /**
     * use this method to synchronize card using state between framework and
     * upper levels An extreme situation this method needed is that one card
