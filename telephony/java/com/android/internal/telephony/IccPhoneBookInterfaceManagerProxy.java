...
public class IccPhoneBookInterfaceManagerProxy extends IIccPhoneBook.Stub {
	 ...
	 * throws android.os.RemoteException { return
	 * mIccPhoneBookInterfaceManager.updateAdnRecordsInEfBySearch( efid, oldTag,
	 * oldPhoneNumber, newTag, newPhoneNumber, pin2); }
	 */

	/*
	 * public boolean updateAdnRecordsInEfByIndex(int efid, String newTag,
	 * String newPhoneNumber, int index, String pin2) throws
	 * android.os.RemoteException { return
	 * mIccPhoneBookInterfaceManager.updateAdnRecordsInEfByIndex(efid, newTag,
	...
	public boolean updateAdnRecordsInEfBySearch(int efid, String oldTag,
		...
		return mIccPhoneBookInterfaceManager.updateAdnRecordsInEfBySearch(efid,
				oldTag, oldPhoneNumber, oldEmailList, oldAnr, newTag,
				newPhoneNumber, newEmailList, newAnr, newAas, newSne, newGrp,
				newGas, pin2);
	}

	public boolean updateAdnRecordsInEfByIndex(int efid, String newTag,
			String newPhoneNumber, List<String> newEmailList, String newAnr,
