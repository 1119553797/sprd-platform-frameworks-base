...
public class Oplrecord {
    ...
    public String toString() {
        return "OPL Record mOplplmn = " + Integer.toHexString(mOplplmn[0])
                + Integer.toHexString(mOplplmn[1]) + Integer.toHexString(mOplplmn[2]) +
                Integer.toHexString(mOplplmn[3]) + Integer.toHexString(mOplplmn[4])
                + Integer.toHexString(mOplplmn[5]) + ", mOpllac1 =" + mOpllac1
                + ", mOpllac2 =" + mOpllac2 + " ,PNNrecordnum = " + PNNrecordnum;
    }
