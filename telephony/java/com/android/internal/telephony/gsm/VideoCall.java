...
class VideoCall extends Call {
    ...
    /*package*/ VideoCallTracker owner;
    ...
    //add by liguxiang 10-25-11 for NEWMS00132673 begin
    public void sprdHangupAll() throws CallStateException {
    	owner.hangup(this);
    }
    //add by liguxiang 10-25-11 for NEWMS00132673 end
    ...
    /**
     * Called by VideoConnection when it has disconnected
     */
    void
    connectionDisconnected(VideoConnection conn) {
    ...
    /*package*/ boolean
    update (VideoConnection conn, DriverCall dc) {
        State newState;
    ...
    /*package*/ boolean
    isFull() {
        return connections.size() == VideoCallTracker.MAX_CONNECTIONS_PER_CALL;
    }

    //***** Called from VideoCallTracker
    ...
    onHangupLocal() {
        for (int i = 0, s = connections.size()
            ...
            VideoConnection cn = (VideoConnection)connections.get(i);
