...
public class SmsCBMessage {
    ...
    private static SmsCBPage getOneSmsCBPage(String msg, int length) {
        ...
        Log.i(TAG, "getOneSmsCBPage gs :" + mPage.gs + "messageCode : " + mPage.messageCode
        ...
        // Log.v(TAG, "getOneSmsCBPage ENCODING_16BIT byteDecodeData.length: "
        // +byteDecodeData.length );
        // mPage.decodedData = byteDecodeData;
    ...
    public static byte[][] processSmsCBPage(SmsCBPage page, int phoneID) {
        ...
        /*
         * StringBuilder whereArgs = new StringBuilder(page.msgId); String [] ww
         * = new String[]{whereArgs.toString()};
         */
        Cursor cursor = null;
        int cursorCount = 0;
        boolean isNew = true;
    ...
    private static SmsCBPage parseUserData(byte[] msg, int length, SmsCBDcs dcs) {
        ...
        switch (encodingType) {
            ...
            case ENCODING_7BIT:
                ...
                Log.i(TAG, "parseUserData byteoffset  :" + dcs.byteOffset + "bitOffset : "
                        + dcs.bitOffset + "7bit len " + len);
