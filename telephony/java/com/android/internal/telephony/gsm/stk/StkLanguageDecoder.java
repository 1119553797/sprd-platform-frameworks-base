 ...
 *
 */
public class StkLanguageDecoder {

    private HashMap <String,String>mLanguageToCountryMap;
    private static StkLanguageDecoder mInstance;

    private StkLanguageDecoder() {
    ...
    public static StkLanguageDecoder getInstance() {
        if(mInstance == null) {
            mInstance = new StkLanguageDecoder();
        }
