...
public class StkServiceProxy extends Handler {
    ...
    static StkService[] mStkServiceArray;
    ...
    public static StkService getInstance(CommandsInterface ci, SIMRecords sr,
        ...
        if (mStkServiceArray[phoneId] == null) {
            ...
            mStkServiceArray[phoneId] = StkService.getInstance(ci, sr, context, fh, sc);
        } else  {
    ...
    public static StkService getInstance(int phoneId) {
        if (sStkServiceProxy == null) {
            sStkServiceProxy = new StkServiceProxy();
        }
    ...
    private StkServiceProxy(){
        mStkServiceArray = new StkService[PhoneFactory.getPhoneCount()];
    }
}
