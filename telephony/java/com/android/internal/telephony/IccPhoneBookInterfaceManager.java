...
//							records.clear();
	 ...
	 *            adn number ot be stored Set both newTag and newPhoneNubmer to
	 *            "" means to replace the old record with empty one, aka, delete
	 *            old record
	 * @param pin2
	 ...
	 * if set in the ADN record is ignored. throws SecurityException if no
	 ...
	 *            adn tag to be stored
	 * @param newPhoneNumber
	 *            adn number to be stored Set both newTag and newPhoneNubmer to
	 *            "" means to replace the old record with empty one, aka, delete
	 *            old record
	 * @param index
