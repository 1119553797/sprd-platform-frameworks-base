...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    void showRecentAppsDialog() {
        ...
        //Lino modify for NEWMS00131354 2011.10.18 begin
        mRecentAppsDialog.setOnDismissListener(new OnDismissListener() {

                        @Override
                        public void onDismiss(DialogInterface dialog) {
                                // TODO Auto-generated method stub
                                mRecentAppsDialog = null;
                        }
                });
        //Lino modify for NEWMS00131354 2011.10.18 end
