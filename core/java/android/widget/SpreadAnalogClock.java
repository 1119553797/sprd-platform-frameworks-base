 ...
 */
@RemoteView
public class SpreadAnalogClock extends View {
	Time mCalendar;
...
//	private String mWeek;
	...
	public SpreadAnalogClock(Context context) {
		this(context, null);
	}

	public SpreadAnalogClock(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SpreadAnalogClock(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		Resources r = mContext.getResources();
		TypedArray a = context
				.obtainStyledAttributes(attrs,
						com.android.internal.R.styleable.SpreadAnalogClock,
						defStyle, 0);

		mDial = a
				.getDrawable(com.android.internal.R.styleable.SpreadAnalogClock_spread_dial);
		if (mDial == null) {
			mDial = r.getDrawable(com.android.internal.R.drawable.clock_dial);
		}

		mHourHand = a
				.getDrawable(com.android.internal.R.styleable.SpreadAnalogClock_spread_hand_hour);
		if (mHourHand == null) {
			mHourHand = r
		...
		mMinuteHand = a
				.getDrawable(com.android.internal.R.styleable.SpreadAnalogClock_spread_hand_minute);
		if (mMinuteHand == null) {
			mMinuteHand = r
		...
		mSecondHand = a
				.getDrawable(com.android.internal.R.styleable.SpreadAnalogClock_spread_hand_second);
