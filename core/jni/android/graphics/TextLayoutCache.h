...
private:
    /**
     * Clusters Typeface vector
     */
    Vector<SkTypeface*> mClusterTypefaces;
    /**
     * Clusters length vector
     */
    Vector<size_t> mClusterLengths;
    /**
     * Clusters advance vector
     */
    Vector<jfloat> mClusterAdvances;
    /**
