...
FACTORY_CREATE(IMAADPCMDecoder)
...
//    { MEDIA_MIMETYPE_AUDIO_MPEG, "OMX.TI.MP3.decode" },
    ...
    { MEDIA_MIMETYPE_AUDIO_MPEG_LAYER_I, "MP3Decoder" },
    { MEDIA_MIMETYPE_AUDIO_MPEG_LAYER_II, "MP3Decoder" },
...
//    { MEDIA_MIMETYPE_AUDIO_AMR_WB, "OMX.PV.amrdec" },
    ...
    { MEDIA_MIMETYPE_AUDIO_IMAADPCM, "IMAADPCMDecoder" },
...
//    { MEDIA_MIMETYPE_AUDIO_AAC, "OMX.PV.aacenc" },
    ...
    { MEDIA_MIMETYPE_VIDEO_MPEG4, "OMX.PV.mpeg4enc" },//@zha
...
//    { MEDIA_MIMETYPE_VIDEO_MPEG4, "OMX.PV.mpeg4enc" },
    ...
    { MEDIA_MIMETYPE_VIDEO_H263, "OMX.PV.h263enc" },//@zha
...
uint32_t OMXCodec::getComponentQuirks(
    ...
    if (!strcmp(componentName, "OMX.PV.mpeg4dec")) {
	quirks |= kDefersOutputBufferAllocation;
        quirks |= kRequiresAllocateBufferOnOutputPorts;
    }
...
status_t OMXCodec::setVideoOutputFormat(
...
#if 1
    {
        ...
        CHECK(format.eColorFormat == OMX_COLOR_FormatYUV420Planar
               ...
               || format.eColorFormat == OMX_SPRDH264_COLOR_FormatYVU420Planar
