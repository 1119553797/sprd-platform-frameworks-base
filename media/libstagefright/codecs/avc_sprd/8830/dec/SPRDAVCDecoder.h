...
//    FT_H264GetBufferDimensions mH264GetBufferDimensions;
    ...
    static int32_t ExtMemAllocWrapper(void* aUserData, uint32 * buffer_array, uint32 buffer_num, uint32 buffer_size) ;
    static int32_t BindFrameWrapper(void *aUserData, void *pHeader);
    static int32_t UnbindFrameWrapper(void *aUserData, void *pHeader);

    int VSP_malloc_cb(uint32 * buffer_array, uint32 buffer_num, uint32 buffer_size);
