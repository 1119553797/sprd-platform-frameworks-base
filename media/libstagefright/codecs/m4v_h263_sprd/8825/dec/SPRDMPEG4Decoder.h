...
#ifndef MIX_SPRD_MPEG4_H_

#define MIX_SPRD_MPEG4_H_
...
private:
    ...
    static int32_t fluchCacheWrapper(void* aUserData,int* vaddr,int* paddr,int size); 
    ...
    int fluchCache (int* vaddr,int* paddr,int size);
